	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Seller Dashboard</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage Products</span>
                    ...
                    <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage Stores</span>
                    </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Seller" /> <span class="text-dark">Seller</span>
              </a>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="#" target="_blank"><strong>Seller Panel</strong></a> - <a class="text-muted" href="#" target="_blank"><strong>E-commerce Dashboard</strong></a>								&copy;
							</p>
						</div>
